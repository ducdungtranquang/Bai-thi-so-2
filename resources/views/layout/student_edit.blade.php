...
<body>
    <div class="container mt-5" style="width:50%">
        <h1 class="text-center">Sua Thong Tin</h1>
        <form class="mt-5" method="post" action="{{route('user.edit',['id'=>$user->id])}}">
            @csrf
            @method('put')
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Ho ten</label>
              <input type="text" class="form-control" value="{{$user->fullname}}" name="fullname">
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Sinh nhat</label>
